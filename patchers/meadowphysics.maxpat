...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 894.0, 670.0, 73.0, 22.0 ],
					"text" : "sprintf 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 878.0, 621.0, 66.0, 22.0 ],
					"text" : "delay 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 753.0, 641.0, 88.0, 22.0 ],
...
,
					"patching_rect" : [ 753.0, 601.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 449.0, 181.0, 22.0 ],
					"text" : "prepend /mp/grid/led/row"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.0, 68.0, 97.0, 22.0 ],
					"text" : "varbright $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.5, 24.0, 39.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 242.0, 30.5, 39.0, 20.0 ],
					"text" : "mono"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.5, 24.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 222.5, 30.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.5, 314.0, 47.0, 22.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 660.0, 458.0, 33.0 ],
									"text" : "set notes with graph, to be output to either a plugin or midi output port."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 39.0, 249.0, 20.0 ],
									"text" : "rhizomatic cascading counter."
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 554.0, 3.5, 32.0, 22.0 ],
					"text" : "***"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 301.0, 225.0, 245.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 393.5, 298.0, 26.0 ],
...
,
					"patching_rect" : [ 301.0, 170.0, 278.0, 51.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 340.5, 252.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 340.5, 44.0, 44.0 ],
					"varname" : "plugindac"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 643.0, 217.0, 122.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 643.0, 187.0, 70.0, 23.0 ],
					"text" : "zl group 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 643.0, 160.0, 108.0, 23.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 927.0, 182.0, 97.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 318.5, 61.0, 34.0 ],
					"text" : "plugin\n",
					"varname" : "pluginlabel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 934.0, 120.0, 47.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 318.5, 47.0, 34.0 ],
					"text" : "midi\n",
					"varname" : "midilabel"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 217.0, 340.5, 64.0, 22.0 ],
					"text" : "refresh",
					"textjustification" : 0,
					"varname" : "midirefresh"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 340.5, 196.0, 22.0 ],
					"varname" : "midiport"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.5, 597.0, 205.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage mp @savemode 3",
					"varname" : "mp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 815.0, 344.0, 90.0, 22.0 ],
					"text" : "r mp-output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.5, 596.0, 75.0, 22.0 ],
					"text" : "s mp-note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 387.0, 90.0, 22.0 ],
					"text" : "s mp-offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 455.0, 75.0, 22.0 ],
					"text" : "s mp-sosc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 4.0, 75.0, 22.0 ],
					"text" : "r mp-sosc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 152.5, 270.0, 66.0, 22.0 ],
					"text" : "metro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.5, 394.0, 253.0, 22.0 ],
					"text" : "prepend /mp/grid/led/level/map 8 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 421.0, 253.0, 22.0 ],
					"text" : "prepend /mp/grid/led/level/map 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 22.0, 362.0, 205.0, 22.0 ],
					"text" : "route map0 map1 trigger row"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 314.0, 109.0, 22.0 ],
					"text" : "sprintf redraw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 296.0, 61.0, 22.0 ],
					"text" : "r mp-js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 164.5, 83.0, 22.0 ],
					"text" : "size $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 206.5, 61.0, 22.0 ],
					"text" : "s mp-js"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 631.0, 61.0, 22.0 ],
					"text" : "s mp-js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 22.0, 130.0, 268.0, 22.0 ],
					"text" : "route /mp/grid/key /sys/size /sys/id"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 571.5, 95.0, 22.0 ],
					"text" : "sprintf next"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 328.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "mp.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 339.0, 32.5, 248.0, 406.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 652.5, 212.0, 652.5, 212.0 ],
					"source" : [ "obj-87", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 652.5, 193.0, 652.5, 193.0 ],
					"source" : [ "obj-98", 0 ]
				}
