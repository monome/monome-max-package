...
,
		"classnamespace" : "box",
		"openrect" : [ 34.0, 100.0, 850.0, 451.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 906.0, 645.0, 73.0, 22.0 ],
					"text" : "sprintf 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 906.0, 614.0, 52.0, 22.0 ],
					"text" : "del 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 348.0, 331.0, 66.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 315.0, 117.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 637.0, 328.0, 73.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 144.0, 75.0, 20.0 ],
					"text" : "transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 697.5, 270.0, 66.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 177.5, 116.0, 68.0, 20.0 ],
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 113.5, 154.0, 25.0 ],
					"varname" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 435.0, 343.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 168.0, 50.0, 22.0 ],
					"varname" : "length"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 301.0, 204.0, 245.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 372.5, 298.0, 26.0 ],
...
,
					"patching_rect" : [ 301.0, 169.0, 347.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 319.5, 252.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 322.0, 44.0, 44.0 ],
					"varname" : "plugindac"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 217.0, 122.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 663.0, 187.0, 70.0, 23.0 ],
					"text" : "zl group 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 663.0, 160.0, 108.0, 23.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 297.5, 61.0, 34.0 ],
					"text" : "plugin\n",
					"varname" : "pluginlabel"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 297.5, 47.0, 34.0 ],
					"text" : "midi\n",
					"varname" : "midilabel"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 250.5, 150.0, 20.0 ],
					"text" : "output"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 198.0, 150.0, 20.0 ],
					"text" : "preset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 272.5, 70.0, 22.0 ],
					"varname" : "output-mode"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 217.0, 319.5, 64.0, 22.0 ],
					"text" : "refresh",
					"textjustification" : 0,
					"varname" : "midirefresh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 837.0, 533.0, 68.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 319.5, 196.0, 22.0 ],
					"varname" : "midiport"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 159.0, 220.0, 53.0, 22.0 ],
					"text" : "recall",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 220.0, 53.0, 22.0 ],
					"text" : "store",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 220.0, 20.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 220.0, 50.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 403.0, 90.0, 22.0 ],
					"text" : "s flin-note"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 144.0, 50.0, 22.0 ],
					"varname" : "offset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 177.5, 59.5, 32.0, 20.0 ],
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 116.0, 59.5, 32.0, 20.0 ],
					"text" : "div"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.5, 59.5, 32.0, 20.0 ],
					"text" : "bpm"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 54.0, 168.0, 73.0, 22.0 ],
									"text" : "s flin-js"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 59.5, 25.0, 20.0 ],
					"text" : "on"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 116.0, 81.5, 50.0, 22.0 ],
					"varname" : "div"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.5, 81.5, 50.0, 22.0 ],
					"varname" : "bpm"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 177.5, 81.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 91.5, 522.0, 66.0, 22.0 ],
					"text" : "metro 40"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 81.5, 20.0, 20.0 ],
					"varname" : "on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 152.5, 270.0, 88.0, 22.0 ],
					"text" : "metro 16.67"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 59.0, 362.0, 109.0, 22.0 ],
					"text" : "route note osc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.5, 302.0, 109.0, 22.0 ],
					"text" : "sprintf redraw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 22.0, 130.0, 282.0, 22.0 ],
					"text" : "route /flin/grid/key /sys/size /sys/id"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 672.5, 212.0, 672.5, 212.0 ],
					"source" : [ "obj-87", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 672.5, 193.0, 672.5, 193.0 ],
					"source" : [ "obj-98", 0 ]
				}
